    ...
    public SecurityFilterChain security(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/order/{orderId}/pay").permitAll()
                .requestMatchers(HttpMethod.GET, "/reports/top-users").permitAll()
                .requestMatchers(HttpMethod.GET, "/reports/average-ticket").permitAll()
                .requestMatchers(HttpMethod.GET, "/reports/monthly-revenue").permitAll()
